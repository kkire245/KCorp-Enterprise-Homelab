...
**Phase:** Phase 2 — Bridge to the Cloud (Hybrid Identity)
**Category:** Hybrid Identity

## Goal
Bridge the on-prem `kcorp.local` Active Directory environment (built in Phase 1) to the existing KCorp Entra ID tenant (built in Phase 0), establishing a real hybrid identity environment, on-prem AD as the source of truth, syncing to the cloud via Microsoft Entra Connect.
...
This completes Phase 2 and the three foundational pieces of the KCorp lab: Entra ID, on-prem Active Directory, and now hybrid identity connecting the two.
