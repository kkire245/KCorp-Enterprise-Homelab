...
## Project Goal
Build a realistic, documented enterprise identity environment from the ground up — starting with on-prem Active Directory administration, then extending into hybrid identity and cloud IAM (Entra ID, Conditional Access, PIM, Governance) — to develop and demonstrate real, configurable skills rather than just certification knowledge.
